    ...
    return (
        <div className='flex flex-col min-w-full'>
            ...
            <div className='flex gap-2 justify-start items-start w-full py-2'>
                ...
                <FileImage className="w-7 h-7 p-[6px] hover:bg-slate-300/10 rounded-lg"/>
            ...
            {/* english translation */}
            <p className='text-base md:text-base py-3 font-serif text-gray-200'>{data.translation.en}</p>
